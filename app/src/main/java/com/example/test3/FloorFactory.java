...
public class FloorFactory {
    ...
    public Floor createFloor(Context context, int floorNumber, List<Hero> existingHeroes){
        List<Hero> heroes = (existingHeroes != null && !existingHeroes.isEmpty()) ? existingHeroes : createNewHeroes();
        ...
        heroStartingPositions.add(new Pair<>(4, 0));
    ...
    public void getNewestFloor() {

    }

    private List<Hero> createNewHeroes(){
        List<Hero> heroes = new ArrayList<>();
        heroes.add(CharacterFactory.createWarrior());
        heroes.add(CharacterFactory.createWarrior());
        heroes.add(CharacterFactory.createMage());
        heroes.add(CharacterFactory.createRanger());
        heroes.add(CharacterFactory.createRanger());
        return heroes;
    }
}
